...
<main class="main-content  mt-0">
        ...
        <div class="page-header min-vh-100">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto" style="border-radius: 15px;">
                        <div class="text-center mb-4">
                            <img src="../assets/img/unib.png" alt="UNIB" class="img-fluid"
                                style="max-height: 150px; width: auto; margin-bottom: -75px;">
                        </div>
                        <div class="card card-plain mt-4">
                            <div class="card-header pb-0 text-left bg-transparent text-center">
                                <h3 class="font-weight-black text-dark display-6">Selamat Datang</h3>
                                <p class="mb-0">Selamat datang di Manajemen Keuangan FKIK Universitas Bengkulu</p>
                            </div>
