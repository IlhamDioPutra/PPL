                ...
                <div class="col-md-12">
                    <div class="d-md-flex align-items-center mb-3 mx-2">
                        <div class="mb-md-0 mb-3">
                            <h3 class="font-weight-bold mb-0">Hello, Administration</h3>
                        ...
                        div class="swiper-wrapper">
                                ...
                                <div>
                                    <div
                                        ...
                                        <div class="full-background bg-cover"
                                            style="background-image: url('../assets/img/fk2.jpg')"></div>
                                        <div class="card-body text-start px-3 py-0 w-100">
                                            <div class="row mt-12">
                                                <div class="col-sm-3 mt-auto">
                                                    ...
                                                    <h5 class="text-dark font-weight-bolder">Gedung Fakultas</h5>
                                                </div>-->
                                           <!-- </div>
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                                    <div class="full-background bg-cover"
                                        style="background-image: url('../assets/img/fk4.jpg')"></div>
                                    <div class="card-body text-start px-3 py-0 w-100">
                                        <div class="row mt-12">
                                                <div class="col-sm-3 mt-auto">
                                                <h4 class="text-dark font-weight-bolder">#3</h4>
                                                <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0">Name</p>
                                                <h5 class="text-dark font-weight-bolder">Struktur</h5>
                                            </div>-->
                                        <!--</div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
                    <div class="card shadow-xs border h-100">
                        <div class="card-header pb-0">
                            <h6 class="font-weight-semibold text-lg mb-0">Anggaran Dana VS Pengeluaran</h6>
                            <p class="text-sm">Disini untuk melihat keseimbangan antara anggaran dana yang ada dan pengeluarannya</p>
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio1"
                                    autocomplete="off" checked>
                                <label class="btn btn-white px-3 mb-0" for="btnradio1">1 Tahun</label>
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio2"
                                    autocomplete="off">
                                <label class="btn btn-white px-3 mb-0" for="btnradio2">1 Bulan/label>
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio3"
                                    autocomplete="off">
                                <label class="btn btn-white px-3 mb-0" for="btnradio3">1 Minggu</label>
                            </div>
                        </div>
                    ...
                    <div class="card shadow-xs border">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Transaksi Terkini</h6>
                                    <p class="text-sm mb-sm-0 mb-2">Rincian Transaksi Terakhir</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <button type="button"
                                        ...
                                        <span class="btn-inner--text">Unduh</span>
                                    </button>
                                </div>
                            </div>
