<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse px-0 py-0 w-auto h-auto" id="sidenav-collapse-main">
        <div class="side-bar">
            <div class="menu">
              <div class="item">
              ...
              <div class="item">
                ...
                <div class="sub-menu">
                  <a href="{{ route('Tup.RincianTup.index') }}" class="sub-item">Daftar Rincian Penggunaa TUP</a>
