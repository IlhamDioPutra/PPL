<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0">
            ...
            <span class="font-weight-bold text-lg">E-Finance FKIK</span>
        </a>
    </div>
    <div class="collapse navbar-collapse  px-4  w-auto h-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="menu-item {{ \Request::route()->getName() == 'RBA.DaftarKegiatan.index' ? 'active' : '' }}">
                <a href="{{ route('RBA.DaftarKegiatan.index') }}" class="nav-link">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<style>
    ...
    .dropdown-menu {
        background-color: #ffffff;
        /* Warna latar belakang submenu (putih) */
    }
    ...
    .dropdown-menu .nav-link {
        padding: 10px;
        /* Sesuaikan sesuai kebutuhan desain Anda */
        color: #fdfdfd;
        /* Warna teks submenu */
    }
    ...
    .dropdown-menu .nav-link:hover {
        ...
        /* Warna latar belakang saat submenu dihover */
    }

    .submenu .nav-link.active {
        background-color: #f8f9fa;
        /* Warna latar belakang saat submenu aktif */
        color: #212529;
        /* Warna teks saat submenu aktif */
    }
</style>
