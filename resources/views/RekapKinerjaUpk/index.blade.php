    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <div class="card border shadow-xs mb-4">
            <div class="row justify-content-center">
                 <h6 class="text-center" style="padding-top: 15px;margin-bottom: 8px;margin-top: 8px;margin-left: 15px;"> REKAP KINERJA UPK GUP </h6>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-sm text-secondary mb-0 text-center">
                        <a href="{{ route('Gup.RekapKinerjaUpk.detail', $bulan) }}" class="btn btn-info">Lihat Detail</a>
                      </td>
                    </tr>
                    @endforeach
                    @endif
