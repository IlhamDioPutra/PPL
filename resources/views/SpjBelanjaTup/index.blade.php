...
@section('content')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <div class="card border shadow-xs mb-4">
          <h6 class="text-center" style="padding-top: 15px;margin-bottom: 8px;margin-top: 8px;margin-left: 15px;">Rekap Surat PertanggungJawaban Belanja TUP</h3>
          {{-- @include('component.pesan') --}}
            ...
            <div class="card-body px-0 py-0">
                ...
                <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                  <a href="{{ route('TUP.SpjBelanjaTup.create') }}">
                  <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                      ...
                      <span class="btn-inner--text" style="font-size: 1.2em;">Tambahkan SPJ BELANJA TUP</span>
                    </button></a>
